...
- Include the following exercises:
  - Setup fabric-cicd locally (run with python, Lab 1 already ensures python installation)
  - Run fabric-cicd locally
    - Show some configurations such as deploy only reports or semantic models
    - Call out parametrization
    - Show items being deployed as code
  - Setup Fabric-CICD in GitHub
    - Co-Development explanation with branching
    - Configure Service Principal - follow example from the doc using Azure Identity    
